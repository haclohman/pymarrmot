...
from pymarrmot.functions.autocalibration.spotpy_setup_sacramento_hourly import spotpy_setup as setup
...
sampler=spotpy.algorithms.sceua(spotpy_setup, dbname='./output/' + 'SCEUA_sacramento', dbformat='csv')
sampler.sample(reps) #, ngs=7, kstop=10, peps=0.001, pcento=0.001
results = spotpy.analyser.load_csv_results('./output/SCEUA_sacramento')
